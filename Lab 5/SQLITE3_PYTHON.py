...
2. What species are in the database?
3. Add species Sus scropa in the database! (species table)
4. What proteins are longer than 1000AA?
5. Which species are present in the NHR3 family? Give full list.
6. How many proteins from each specie are present in the database?
7. Change the schema and add column for structure, resolution and method. Add example protein with all.
8. How do you extract the data from the results of SELECT commands?
9. What happens when you insert Sus scrofa a second time?
"""
...
if __name__=='__main__':
    ...
    try:
        ...
        sql.add('protein', ('NH3', 'Ss', 'abracadabra', '2xkg, 5fvl, 6eny', '1.6Å', 'Solution NMR and X-ray diffraction'))
    except:
